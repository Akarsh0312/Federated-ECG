...
def get_images_data(features, labels, n_data, directory_name, augment=True):
    ...
    if not os.path.exists(settings.images_hdf5_path):
        os.makedirs(settings.images_hdf5_path)
...
def main(winL=90, winR=90, do_preprocess=True, 
    ...
    # Load train data 
    [tr_features, tr_labels, tr_patient_num_beats,my_db] = load_mit_db('DS1', winL, winR, do_preprocess,
    ...
    if my_db is not None:
        print("RMSSD Value (ms):", my_db.rmssd_value)
        print("Mental Stress Status:", my_db.stress_status)
        print("Stress Label:", my_db.stress_label)
    else:
        print("Stress data not available (loaded from cached features)")
    print("=================================\n")
...
def main_federated(winL=90, winR=90, do_preprocess=True, 
    ...
    print("Stress Label:", my_db.stress_label)
    print("=================================\n")
    #print("Mental Stress Status:", settings.stress_status)
